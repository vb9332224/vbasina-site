  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Отвечаю на сообщения в течение 24 часов в рабочие дни. На срочные запросы по антирейдерской защите — в течение 4 часов."
      />
          ...
          <Reveal className="lg:col-span-2 space-y-8">
            ...
            <div>
              ...
              <p className="text-cream-100/85 text-sm leading-relaxed">
                ...
                <br />
                Срочные запросы по антирейдерской защите — в течение 4 часов.
              </p>
            </div>
          </Reveal>

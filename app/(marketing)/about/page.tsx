...
const founderImpact = [
  ...
  "Инициировала применение проектного финансирования и эскроу-счетов в строительстве индивидуальных домов — чтобы защитить семьи от недобросовестных подрядчиков.",

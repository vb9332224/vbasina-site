  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Землепродюсерская компания. Создаём индустрии и упаковываем земельные активы в инвестиционно-привлекательные продукты — там, где институциональный девелопмент только формируется. Под брендом BGM Consulting объединена 17-летняя экспертиза основателя — Виолетты Басиной, автора первого в России проектного финансирования ИЖС и инициатора государственного Фонда защиты прав дольщиков."
      >

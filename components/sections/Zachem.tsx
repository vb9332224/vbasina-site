...
const cards = [
  ...
  {
    n: "02",
    title: "Защищаем бизнес в кризисных ситуациях",
    body:
      "Если ваш проект попал под давление — банкротный сценарий, корпоративный конфликт, рейдерская атака — мы знаем, как структурировать защиту. Не через борьбу с системой, а через создание параллельных легальных структур. Прошли это сами.",
  },
  {
    n: "03",

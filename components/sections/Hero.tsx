        ...
        <div className="lg:col-span-3">
          ...
          <Reveal delay={0.15}>
            <p className="mt-8 text-base md:text-lg text-cream-100/80 leading-relaxed max-w-2xl">
              ...
              льготную ИЖС-ипотеку, инициировала государственный Фонд защиты прав дольщиков.
              Прошла рейдерский захват и нашла из него выход. Работаю с банками, девелоперами,
              фондами и собственниками земли в России, Армении, Кыргызстане, Азербайджане и
              Таджикистане — на рынках, где институциональный девелопмент только формируется.
            </p>
          </Reveal>

...
const figures = [
  { value: "1-я", label: "первое в России проектное финансирование ИЖС (28.12.2020)" },
  { value: "6,1%", label: "первая в России льготная ИЖС-ипотека (2021)" },
  { value: "2,1 млрд ₽", label: "проектного финансирования от Банка ДОМ.РФ" },
  { value: "198", label: "домовладений в первом горизонтальном ИЖС-комплексе РФ" },
];

...
export function BotLauncher({ locale = "ru" }: { locale?: Locale }) {
  ...
  return (
    <a
      ...
      aria-label={aria}
      className="fixed z-40 bottom-20 right-4 md:bottom-6 md:right-6 inline-flex items-center gap-2 md:gap-3 bg-gold-500 hover:bg-gold-300 text-navy-900 px-4 md:px-5 py-3 md:py-3.5 shadow-xl text-sm md:text-[15px] font-semibold transition-colors border border-navy-900/10"
    >
